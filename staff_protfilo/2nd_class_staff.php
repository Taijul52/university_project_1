			...
			<div class="col-md-7 col-md-offset-3">
			   ...
			   <table class="table table-striped">
			   		...
			   		<tr>
			   			...
			   			<th width="90%" class="text-center">Staffs Name</th>
			   		</tr>

			   <?php
 	          $db=new database();
              $query="select * from staff_tbl where class='second class'";
			 ...
			 <?php while ($row=$read->fetch_assoc()) { ?>
			   ...
			   <tr>
			   		<td><?php echo $i ?></td>
			   		<td><a href="../staff_profile.php?id=<?php echo $row['id']; ?>" class="list-group-item list-group-item-info"><?php echo $row['name']; ?></a></td>
			   	</tr>
			   	<?php }?>
	          <?php } ?>
			   </table>
