...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
  ...
  $password=mysqli_real_escape_string($db->link,md5($_POST['password']));
    ...
    if($imgFile)
    {
      $upload_dir = 'img/upload/'; // upload directory 
  ...
  if(!isset($errMSG)){
    $query="update staff_tbl set name='$name',username='$username',designation='$desig', class='$class',email='$email',mobile='$mobile',comment='$comment', password='$password', image='$image' where id=$id";

    $update=$db->update($query);
    header("location:loginstaffprofile.php");
  }
...
<nav class="navbar navbar-default" role="navigation">
    <div class="container">
     ...
     <?php 
        $id=Session::get("id");
        $userlogin=Session::get("staff_login");
        if($userlogin==true){
        ?>
       <ul class="nav navbar-nav navbar-right">
        <li><a href="loginstaffprofile.php?id=<?php echo $id?>">Profile</a></li>
      </ul>
...
<div class="row">
  ...
  ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="sc" value="<?php echo $getdata['class']; ?>" name="class">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="deg" value="<?php echo $getdata['comment']; ?>" name="comment">
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">
         <p><img src="img/upload/<?php echo $getdata['image']; ?>" height="100" width="100" /></p>
