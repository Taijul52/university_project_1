  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
       <div class="panel panel-info">
        ...
        <img src="public/img/upload/<?php echo $row['image']; ?>" alt="image" height="150" width="150" style="border:2px solid #DBDDE0">
         </div>
          <div class="paneltext" style="float:left;margin-left:20px">
           ...
           <p class="">Date of Join :<strong><?php echo $row['doj']; ?></strong></p>
          </div>
         </div>
